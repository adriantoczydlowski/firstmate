...
| `fm-session-lock-lib.sh` | Shared session-lock ownership from harness ancestry, a session-cohort proof, or a trusted Claude session id, plus the suspended-holder and competing-holder verdicts, for fm-lock.sh and the turn-end hooks |
